...
const Home = () => {
    ...
    // Map project titles to their local image files
    const getProjectImage = (title) => {
        const imageMap = {
            'DDoS Detection & Visualization System': '/project-images/ddos.png',
            'EduSense+': '/project-images/edusense+.png',
            'TaskForge': '/project-images/taskforge.png',
            'Real-Time Transaction Reconciliation': '/project-images/Real_Time_Transaction_Reconciliation.jpeg'
        };
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const industryProjects = projectsRes.data.projects.filter(p => p.isIndustry).sort((a, b) => a.order - b.order);
                setProjects(industryProjects);
    ...
    return (
        <div className="home-page">
                ...
                <div className="hero-content">
                    ...
                    <div className="hero-text">
                        ...
                        <div className="hero-buttons">
                            ...
                            <a href="/Shashank-Kakad-Resume.pdf" target="_blank" rel="noopener noreferrer" className="btn-hero-secondary">Resume</a>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div className="container">
                    ...
                    <div className="contact-links">
                        ...
                        <a href={`mailto:${about?.email}`} className="contact-link">
                            ...
                            {about?.email || 'shashankkakad10@gmail.com'}
                        </a>
                    </div>
                </div>
            </section>
            ...
            <section className="taskforge-section" id="industry-projects">
                <div className="container">
                    <h2>Industry <span className="highlight-text" style={{ display: 'inline', fontSize: 'inherit' }}>Projects</span></h2>
                    <p style={{ maxWidth: '800px', margin: '0 auto 3rem', fontSize: '1.2rem' }}>
                        Real-world industry collaborations with leading organizations
                    </p>
                            ...
                            <div key={project._id} className="taskforge-box project-card">
                                <div className="project-image-placeholder">
                                    ...
                                    {project.github && (
                                        ...
                                        >
                                            <img src="/github-logo.png" alt="GitHub" className="github-logo-img" />
                                        </a>
                                    )}
                                </div>
                                {project.organization && (
                                    <div style={{ paddingLeft: '2rem', paddingRight: '2rem', paddingTop: '1.25rem' }}>
                                        <span style={{
